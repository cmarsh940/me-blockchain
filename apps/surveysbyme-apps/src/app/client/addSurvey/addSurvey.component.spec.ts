...
describe('addSurveyComponent', () => {
  ...
  let mockaddSurveyService;
  let mockDataService

  beforeEach(async(() => {

    mockaddSurveyService = sinon.createStubInstance(addSurveyService);
    mockaddSurveyService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: addSurveyService, useValue: mockaddSurveyService },
